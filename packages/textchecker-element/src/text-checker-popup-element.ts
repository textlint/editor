...
${items.map(item => {
            if (item.message) {
                return html`<li class="popup-listItem" style="--padding: ${leftPadding}px"><p class="popup-listItem-message">${item.message}</p>
<p class="popup-listItem-content">${item.icon}${item.label}</p></li>`

            }
            return html`<li class="popup-listItem" style="--padding: ${leftPadding}px"><p class="popup-listItem-content">${item.icon}${item.label}</p></li>`
        })}
</ul>`;
